                        ...
                        <div class="-m-1.5 overflow-x-auto">
                          <div class="p-1.5 min-w-full inline-block align-middle">
                            <div class="border rounded-lg overflow-hidden dark:border-gray-700">
                                <form action="{{ route('admin.users.store') }}" method="POST" class="py-2 px-2">
                                    @csrf
                                    <label for="name" class="flex justify-center">Name</label>
                                    ...
                                    <input type="text" name="email" class="text-center text-lg  py-3 px-4 block w-full border-gray-200 rounded-md focus:border-blue-500 focus:ring-blue-500 bg-slate-300 dark:border-gray-700 dark:text-black">
                                    @error('email')
                                        <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                    <label for="name" class="flex justify-center">Password</label>
                                    <input type="password" name="password" class="text-center text-lg  py-3 px-4 block w-full border-gray-200 rounded-md focus:border-blue-500 focus:ring-blue-500 bg-slate-300 dark:border-gray-700 dark:text-black">
                                    @error('name')
                                        <div class="text-red-500">{{ $message }}</div>
                                    @enderror
